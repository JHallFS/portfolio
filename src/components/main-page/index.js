export default function Hero() {
	return (
		<section>
			...
			The fiance is enjoying well earned success! Its an inspiring moment for me as I am currently looking to use the full stack web development certificate I recieved from the University of Arizona to get started in a career in web and software development to chase the inspirations I had as a child and settle into the next stage of my working life.
